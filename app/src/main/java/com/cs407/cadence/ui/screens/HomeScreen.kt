            ...
            Column(
                ...
                Column(
                    ...
                    if (isLoading) {
                        ...
                        RecentActivityCard(workoutSession = lastSession!!)
                    } else {
...
fun DayCard(modifier: Modifier = Modifier, date: LocalDate, hasWorkout: Boolean, isToday: Boolean) {
    ...
    Card(
        ...
        Column(
                modifier = Modifier.padding(vertical = 15.dp, horizontal = 10.dp).fillMaxWidth(),
                horizontalAlignment = Alignment.CenterHorizontally,
            ...
            Icon(
                    ...
                    tint = dateColor,
                    modifier = Modifier.size(20.dp).alpha(if (hasWorkout) 1f else 0f)
            )
        }
    }
}
...
fun StartButton() {
    ...
    Row(
        ...
        Image(
                ...
                modifier = Modifier.height(180.dp).rotate(rotation)
        )
    }
}
